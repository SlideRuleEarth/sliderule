...
<img src="https://slideruleearth.io/web/assets/images/SlideRule-whiteBelly.png" alt="SlideRule Logo" style="float:left; margin: 0 15px 15px 0; width:150px;"> A cloud-native framework for on-demand science data processing. Hosted at [slideruleearth.io](https://slideruleearth.io).
