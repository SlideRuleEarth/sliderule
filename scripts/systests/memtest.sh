...
valgrind_options="--leak-check=full --show-leak-kinds=all --show-reachable=no --track-origins=yes --track-fds=yes --log-file=${logfile} --suppressions=${valgrind_suppressions}"
