...
runner.command(string.format('ut_dictionary::ADD_WORD_SET small %s/alphabet_words.txt', rd))
runner.command(string.format('ut_dictionary::ADD_WORD_SET large %s/english_words.txt', rd))
