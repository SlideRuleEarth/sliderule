...
See the [asset directory](https://github.com/SlideRuleEarth/sliderule/blob/main/apps/node/packages/core/extensions/earth_data_query.lua) for details on which rasters can be sampled.
