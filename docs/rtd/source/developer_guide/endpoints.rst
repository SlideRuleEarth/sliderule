...
``POST /source/h5 <request payload>``
    ...
    See `h5.h5 </api_reference/h5.html#h5>`_ function for a convenient method for accessing HDF5 datasets.
...
``POST /source/h5p <request payload>``
    ...
    See `h5.h5p </api_reference/h5.html#h5p>`_ function for a convenient method for accessing HDF5 datasets.
