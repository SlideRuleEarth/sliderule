...
|---------|-----------|-----|-------|
|asset|Source data asset, see [asset directory](https://github.com/SlideRuleEarth/sliderule/blob/main/packages/core/extensions/earth_data_query.lua)|string|api specific|
