...
* `poly`: polygon defining region of interest (see [polygons](/web/rtd/user_guide/basic_usage.html#polygons))
* `region_mask`: geojson describing region of interest which enables rasterized subsetting on servers (see [geojson](/web/rtd/user_guide/basic_usage.html#rasterized-area-of-interest))
