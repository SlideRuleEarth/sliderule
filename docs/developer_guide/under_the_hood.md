...
Logs and metrics for the cluster are maintained by the [Recorder](https://github.com/SlideRuleEarth/sliderule/tree/main/apps/recorder) which provides a kinesis firehose stream for both alerts and telemetry messages generated by the rest of the SlideRule system.
