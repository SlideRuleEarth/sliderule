...
RecordObject::recordDefErr_t AtlasHistogram::defineHistogram(const char* rec_type, int data_size, fieldDef_t* fields, int num_fields)
{
    ...
    {
        addField(def, "SIZE",              INT32,  offsetof(hist_t, size),                                         1,   NATIVE_FLAGS);
        addField(def, "SUM",               INT32,  offsetof(hist_t, sum),                                          1,   NATIVE_FLAGS);
        addField(def, "TYPE",              INT32,  offsetof(hist_t, type),                                         1,   NATIVE_FLAGS);
        addField(def, "INTPERIOD",         INT32,  offsetof(hist_t, integrationPeriod),                            1,   NATIVE_FLAGS);
        addField(def, "BINSIZE",           DOUBLE, offsetof(hist_t, binSize),                                      1,   NATIVE_FLAGS);
        addField(def, "PCE",               INT32,  offsetof(hist_t, pceNum),                                       1,   NATIVE_FLAGS);
        addField(def, "MFC",               INT64,  offsetof(hist_t, majorFrameCounter),                            1,   NATIVE_FLAGS);
        addField(def, "MFP",               INT8,   offsetof(hist_t, majorFramePresent),                            1,   NATIVE_FLAGS);
        addField(def, "GPS",               DOUBLE, offsetof(hist_t, gpsAtMajorFrame),                              1,   NATIVE_FLAGS);
        addField(def, "RWS",               DOUBLE, offsetof(hist_t, rangeWindowStart),                             1,   NATIVE_FLAGS);
        addField(def, "RWW",               DOUBLE, offsetof(hist_t, rangeWindowWidth),                             1,   NATIVE_FLAGS);
        addField(def, "TXCNT",             INT32,  offsetof(hist_t, transmitCount),                                1,   NATIVE_FLAGS);
        addField(def, "BKGND",             DOUBLE, offsetof(hist_t, noiseFloor),                                   1,   NATIVE_FLAGS);
        addField(def, "BINBKG",            DOUBLE, offsetof(hist_t, noiseBin),                                     1,   NATIVE_FLAGS);
        addField(def, "SIGRNG",            DOUBLE, offsetof(hist_t, signalRange),                                  1,   NATIVE_FLAGS);
        addField(def, "SIGWID",            DOUBLE, offsetof(hist_t, signalWidth),                                  1,   NATIVE_FLAGS);
        addField(def, "SIGPES",            DOUBLE, offsetof(hist_t, signalEnergy),                                 1,   NATIVE_FLAGS);
        addField(def, "PKT_BYTES",         INT32,  offsetof(hist_t, pktBytes),                                     1,   NATIVE_FLAGS);
        addField(def, "PKT_ERRORS",        INT32,  offsetof(hist_t, pktErrors),                                    1,   NATIVE_FLAGS);
        addField(def, "TEP_START",         INT32,  offsetof(hist_t, ignoreStartBin),                               1,   NATIVE_FLAGS);
        addField(def, "TEP_STOP",          INT32,  offsetof(hist_t, ignoreStopBin),                                1,   NATIVE_FLAGS);
        addField(def, "MAXVAL[0]",         INT32,  offsetof(hist_t, maxVal[0]),                                    1,   NATIVE_FLAGS);
        addField(def, "MAXVAL[1]",         INT32,  offsetof(hist_t, maxVal[1]),                                    1,   NATIVE_FLAGS);
        addField(def, "MAXVAL[2]",         INT32,  offsetof(hist_t, maxVal[2]),                                    1,   NATIVE_FLAGS);
        addField(def, "MAXBIN[0]",         INT32,  offsetof(hist_t, maxBin[0]),                                    1,   NATIVE_FLAGS);
        addField(def, "MAXBIN[1]",         INT32,  offsetof(hist_t, maxBin[1]),                                    1,   NATIVE_FLAGS);
        addField(def, "MAXBIN[2]",         INT32,  offsetof(hist_t, maxBin[2]),                                    1,   NATIVE_FLAGS);
        addField(def, "RWDROPOUT",         UINT8,  offsetof(hist_t, majorFrameData.RangeWindowDropout_Err),        1,   NATIVE_FLAGS);
        addField(def, "DIDNOTFINISHTX",    UINT8,  offsetof(hist_t, majorFrameData.DidNotFinishTransfer_Err),      1,   NATIVE_FLAGS);
        addField(def, "DIDNOTFINISHWR",    UINT8,  offsetof(hist_t, majorFrameData.DidNotFinishWritingData_Err),   1,   NATIVE_FLAGS);
        addField(def, "DFCEDAC",           UINT32, offsetof(hist_t, majorFrameData.EDACStatusBits),                1,   NATIVE_FLAGS);
        addField(def, "SDRAMMISMATCH",     UINT8,  offsetof(hist_t, majorFrameData.SDRAMMismatch_Err),             1,   NATIVE_FLAGS);
        addField(def, "TRACKINGFIFO",      UINT8,  offsetof(hist_t, majorFrameData.Tracking_FIFOWentFull),         1,   NATIVE_FLAGS);
        addField(def, "STARTTAGFIFO",      UINT8,  offsetof(hist_t, majorFrameData.StartTag_FIFOWentFull),         1,   NATIVE_FLAGS);
        addField(def, "DFCSTATUS",         UINT64, offsetof(hist_t, majorFrameData.DFCStatusBits),                 1,   NATIVE_FLAGS);
    }
