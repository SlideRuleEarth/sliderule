...
RecordObject::fieldDef_t TimeTagHistogram::rec_def[] =
{
    ...
    {"DLB0_START",    UINT32, offsetof(ttHist_t, downlinkBands[0].start),     1,    NULL, NATIVE_FLAGS},
    {"DLB0_WIDTH",    UINT16, offsetof(ttHist_t, downlinkBands[0].width),     1,    NULL, NATIVE_FLAGS},
    {"DLB0_MASK",     UINT16, offsetof(ttHist_t, downlinkBands[0].mask),      1,    NULL, NATIVE_FLAGS},
    {"DLB0_TAGCNT",    INT32, offsetof(ttHist_t, downlinkBandsTagCnt[0]),     1,    NULL, NATIVE_FLAGS},
    {"DLB1_START",    UINT32, offsetof(ttHist_t, downlinkBands[1].start),     1,    NULL, NATIVE_FLAGS},
    {"DLB1_WIDTH",    UINT16, offsetof(ttHist_t, downlinkBands[1].width),     1,    NULL, NATIVE_FLAGS},
    {"DLB1_MASK",     UINT16, offsetof(ttHist_t, downlinkBands[1].mask),      1,    NULL, NATIVE_FLAGS},
    {"DLB1_TAGCNT",    INT32, offsetof(ttHist_t, downlinkBandsTagCnt[1]),     1,    NULL, NATIVE_FLAGS},
    {"DLB2_START",    UINT32, offsetof(ttHist_t, downlinkBands[2].start),     1,    NULL, NATIVE_FLAGS},
    {"DLB2_WIDTH",    UINT16, offsetof(ttHist_t, downlinkBands[2].width),     1,    NULL, NATIVE_FLAGS},
    {"DLB2_MASK",     UINT16, offsetof(ttHist_t, downlinkBands[2].mask),      1,    NULL, NATIVE_FLAGS},
    ...
    {"CHCNT[0]",  INT32, offsetof(ttHist_t, channelCounts) + (0 * sizeof(int32_t)),  1,     NULL, NATIVE_FLAGS},
    {"CHCNT[1]",  INT32, offsetof(ttHist_t, channelCounts) + (1 * sizeof(int32_t)),  1,     NULL, NATIVE_FLAGS},
    {"CHCNT[2]",  INT32, offsetof(ttHist_t, channelCounts) + (2 * sizeof(int32_t)),  1,     NULL, NATIVE_FLAGS},
    {"CHCNT[3]",  INT32, offsetof(ttHist_t, channelCounts) + (3 * sizeof(int32_t)),  1,     NULL, NATIVE_FLAGS},
    {"CHCNT[4]",  INT32, offsetof(ttHist_t, channelCounts) + (4 * sizeof(int32_t)),  1,     NULL, NATIVE_FLAGS},
    {"CHCNT[5]",  INT32, offsetof(ttHist_t, channelCounts) + (5 * sizeof(int32_t)),  1,     NULL, NATIVE_FLAGS},
    {"CHCNT[6]",  INT32, offsetof(ttHist_t, channelCounts) + (6 * sizeof(int32_t)),  1,     NULL, NATIVE_FLAGS},
    {"CHCNT[7]",  INT32, offsetof(ttHist_t, channelCounts) + (7 * sizeof(int32_t)),  1,     NULL, NATIVE_FLAGS},
    {"CHCNT[8]",  INT32, offsetof(ttHist_t, channelCounts) + (8 * sizeof(int32_t)),  1,     NULL, NATIVE_FLAGS},
    {"CHCNT[9]",  INT32, offsetof(ttHist_t, channelCounts) + (9 * sizeof(int32_t)),  1,     NULL, NATIVE_FLAGS},
    {"CHCNT[10]", INT32, offsetof(ttHist_t, channelCounts) + (10 * sizeof(int32_t)), 1,     NULL, NATIVE_FLAGS},
    {"CHCNT[11]", INT32, offsetof(ttHist_t, channelCounts) + (11 * sizeof(int32_t)), 1,     NULL, NATIVE_FLAGS},
    {"CHCNT[12]", INT32, offsetof(ttHist_t, channelCounts) + (12 * sizeof(int32_t)), 1,     NULL, NATIVE_FLAGS},
    {"CHCNT[13]", INT32, offsetof(ttHist_t, channelCounts) + (13 * sizeof(int32_t)), 1,     NULL, NATIVE_FLAGS},
    {"CHCNT[14]", INT32, offsetof(ttHist_t, channelCounts) + (14 * sizeof(int32_t)), 1,     NULL, NATIVE_FLAGS},
    {"CHCNT[15]", INT32, offsetof(ttHist_t, channelCounts) + (15 * sizeof(int32_t)), 1,     NULL, NATIVE_FLAGS},
    {"CHCNT[16]", INT32, offsetof(ttHist_t, channelCounts) + (16 * sizeof(int32_t)), 1,     NULL, NATIVE_FLAGS},
    {"CHCNT[17]", INT32, offsetof(ttHist_t, channelCounts) + (17 * sizeof(int32_t)), 1,     NULL, NATIVE_FLAGS},
    {"CHCNT[18]", INT32, offsetof(ttHist_t, channelCounts) + (18 * sizeof(int32_t)), 1,     NULL, NATIVE_FLAGS},
    {"CHCNT[19]", INT32, offsetof(ttHist_t, channelCounts) + (19 * sizeof(int32_t)), 1,     NULL, NATIVE_FLAGS},

    {"CHBIAS[0]",  DOUBLE, offsetof(ttHist_t, channelBiases) + (0 * sizeof(double)),  1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[1]",  DOUBLE, offsetof(ttHist_t, channelBiases) + (1 * sizeof(double)),  1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[2]",  DOUBLE, offsetof(ttHist_t, channelBiases) + (2 * sizeof(double)),  1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[3]",  DOUBLE, offsetof(ttHist_t, channelBiases) + (3 * sizeof(double)),  1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[4]",  DOUBLE, offsetof(ttHist_t, channelBiases) + (4 * sizeof(double)),  1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[5]",  DOUBLE, offsetof(ttHist_t, channelBiases) + (5 * sizeof(double)),  1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[6]",  DOUBLE, offsetof(ttHist_t, channelBiases) + (6 * sizeof(double)),  1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[7]",  DOUBLE, offsetof(ttHist_t, channelBiases) + (7 * sizeof(double)),  1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[8]",  DOUBLE, offsetof(ttHist_t, channelBiases) + (8 * sizeof(double)),  1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[9]",  DOUBLE, offsetof(ttHist_t, channelBiases) + (9 * sizeof(double)),  1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[10]", DOUBLE, offsetof(ttHist_t, channelBiases) + (10 * sizeof(double)), 1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[11]", DOUBLE, offsetof(ttHist_t, channelBiases) + (11 * sizeof(double)), 1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[12]", DOUBLE, offsetof(ttHist_t, channelBiases) + (12 * sizeof(double)), 1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[13]", DOUBLE, offsetof(ttHist_t, channelBiases) + (13 * sizeof(double)), 1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[14]", DOUBLE, offsetof(ttHist_t, channelBiases) + (14 * sizeof(double)), 1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[15]", DOUBLE, offsetof(ttHist_t, channelBiases) + (15 * sizeof(double)), 1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[16]", DOUBLE, offsetof(ttHist_t, channelBiases) + (16 * sizeof(double)), 1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[17]", DOUBLE, offsetof(ttHist_t, channelBiases) + (17 * sizeof(double)), 1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[18]", DOUBLE, offsetof(ttHist_t, channelBiases) + (18 * sizeof(double)), 1,    NULL, NATIVE_FLAGS},
    {"CHBIAS[19]", DOUBLE, offsetof(ttHist_t, channelBiases) + (19 * sizeof(double)), 1,    NULL, NATIVE_FLAGS},
};
