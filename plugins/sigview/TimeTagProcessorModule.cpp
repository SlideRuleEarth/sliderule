...
{
    {"PCE",        UINT32, offsetof(pktStat_t, pce),        sizeof(((pktStat_t*)0)->pce),           NATIVE_FLAGS},
    {"MFC_ERRORS", UINT32, offsetof(pktStat_t, mfc_errors), sizeof(((pktStat_t*)0)->mfc_errors),    NATIVE_FLAGS},
    {"HDR_ERRORS", UINT32, offsetof(pktStat_t, hdr_errors), sizeof(((pktStat_t*)0)->hdr_errors),    NATIVE_FLAGS},
    {"FMT_ERRORS", UINT32, offsetof(pktStat_t, fmt_errors), sizeof(((pktStat_t*)0)->fmt_errors),    NATIVE_FLAGS},
    {"DLB_ERRORS", UINT32, offsetof(pktStat_t, dlb_errors), sizeof(((pktStat_t*)0)->dlb_errors),    NATIVE_FLAGS},
    {"TAG_ERRORS", UINT32, offsetof(pktStat_t, tag_errors), sizeof(((pktStat_t*)0)->tag_errors),    NATIVE_FLAGS},
    {"PKT_ERRORS", UINT32, offsetof(pktStat_t, pkt_errors), sizeof(((pktStat_t*)0)->pkt_errors),    NATIVE_FLAGS},
    {"WARNINGS",   UINT32, offsetof(pktStat_t, warnings),   sizeof(((pktStat_t*)0)->warnings),      NATIVE_FLAGS},
    {"SUM_TAGS",   UINT32, offsetof(pktStat_t, sum_tags),   sizeof(((pktStat_t*)0)->sum_tags),      NATIVE_FLAGS},
    {"MIN_TAGS",   UINT32, offsetof(pktStat_t, min_tags),   sizeof(((pktStat_t*)0)->min_tags),      NATIVE_FLAGS},
    {"MAX_TAGS",   UINT32, offsetof(pktStat_t, max_tags),   sizeof(((pktStat_t*)0)->max_tags),      NATIVE_FLAGS},
    {"AVG_TAGS",   DOUBLE, offsetof(pktStat_t, avg_tags),   sizeof(((pktStat_t*)0)->avg_tags),      NATIVE_FLAGS}
};
...
void ChStat::defineRecord(void)
{
    ...
    {
        addField(def, "PCE", UINT32, offsetof(chStat_t, pce), sizeof(((chStat_t*)0)->pce), NATIVE_FLAGS);

        for(int i = 0; i < NUM_CHANNELS; i++)
        {
            char field_name[MAX_FIELD_NAME_SIZE];
            addField(def, StringLib::format(field_name, MAX_FIELD_NAME_SIZE, "%s[%d]", "RX_CNT", i),    UINT32, offsetof(chStat_t, rx_cnt) + (i * sizeof(uint32_t)),    sizeof(((chStat_t*)0)->rx_cnt[i]),    NATIVE_FLAGS);
            addField(def, StringLib::format(field_name, MAX_FIELD_NAME_SIZE, "%s[%d]", "NUM_DUPR", i),  UINT32, offsetof(chStat_t, num_dupr) + (i * sizeof(uint32_t)),  sizeof(((chStat_t*)0)->num_dupr[i]),  NATIVE_FLAGS);
            addField(def, StringLib::format(field_name, MAX_FIELD_NAME_SIZE, "%s[%d]", "NUM_DUPF", i),  UINT32, offsetof(chStat_t, num_dupf) + (i * sizeof(uint32_t)),  sizeof(((chStat_t*)0)->num_dupf[i]),  NATIVE_FLAGS);
            addField(def, StringLib::format(field_name, MAX_FIELD_NAME_SIZE, "%s[%d]", "CELL_CNTS", i), UINT32, offsetof(chStat_t, cell_cnts) + (i * sizeof(uint32_t)), sizeof(((chStat_t*)0)->cell_cnts[i]), NATIVE_FLAGS);
            addField(def, StringLib::format(field_name, MAX_FIELD_NAME_SIZE, "%s[%d]", "TDC_CALR", i),  DOUBLE, offsetof(chStat_t, tdc_calr) + (i * sizeof(double)),  sizeof(((chStat_t*)0)->tdc_calr[i]),  NATIVE_FLAGS);
            addField(def, StringLib::format(field_name, MAX_FIELD_NAME_SIZE, "%s[%d]", "MIN_CALR", i),  DOUBLE, offsetof(chStat_t, min_calr) + (i * sizeof(double)),  sizeof(((chStat_t*)0)->min_calr[i]),  NATIVE_FLAGS);
            addField(def, StringLib::format(field_name, MAX_FIELD_NAME_SIZE, "%s[%d]", "MAX_CALR", i),  DOUBLE, offsetof(chStat_t, max_calr) + (i * sizeof(double)),  sizeof(((chStat_t*)0)->max_calr[i]),  NATIVE_FLAGS);
            addField(def, StringLib::format(field_name, MAX_FIELD_NAME_SIZE, "%s[%d]", "AVG_CALR", i),  DOUBLE, offsetof(chStat_t, avg_calr) + (i * sizeof(double)),  sizeof(((chStat_t*)0)->avg_calr[i]),  NATIVE_FLAGS);
            addField(def, StringLib::format(field_name, MAX_FIELD_NAME_SIZE, "%s[%d]", "TDC_CALF", i),  DOUBLE, offsetof(chStat_t, tdc_calf) + (i * sizeof(double)),  sizeof(((chStat_t*)0)->tdc_calf[i]),  NATIVE_FLAGS);
            addField(def, StringLib::format(field_name, MAX_FIELD_NAME_SIZE, "%s[%d]", "MIN_CALF", i),  DOUBLE, offsetof(chStat_t, min_calf) + (i * sizeof(double)),  sizeof(((chStat_t*)0)->min_calf[i]),  NATIVE_FLAGS);
            addField(def, StringLib::format(field_name, MAX_FIELD_NAME_SIZE, "%s[%d]", "MAX_CALF", i),  DOUBLE, offsetof(chStat_t, max_calf) + (i * sizeof(double)),  sizeof(((chStat_t*)0)->max_calf[i]),  NATIVE_FLAGS);
            addField(def, StringLib::format(field_name, MAX_FIELD_NAME_SIZE, "%s[%d]", "AVG_CALF", i),  DOUBLE, offsetof(chStat_t, avg_calf) + (i * sizeof(double)),  sizeof(((chStat_t*)0)->avg_calf[i]),  NATIVE_FLAGS);
            addField(def, StringLib::format(field_name, MAX_FIELD_NAME_SIZE, "%s[%d]", "BIAS", i),      DOUBLE, offsetof(chStat_t, bias) + (i * sizeof(double)),      sizeof(((chStat_t*)0)->bias[i]),      NATIVE_FLAGS);
            addField(def, StringLib::format(field_name, MAX_FIELD_NAME_SIZE, "%s[%d]", "DEAD_TIME", i), DOUBLE, offsetof(chStat_t, dead_time) + (i * sizeof(double)), sizeof(((chStat_t*)0)->dead_time[i]), NATIVE_FLAGS);
        }
    }
}
...
{
    {"PCE",              UINT32, offsetof(txStat_t, pce),         sizeof(((txStat_t*)0)->pce),         NATIVE_FLAGS},
    {"TXCNT",            UINT32, offsetof(txStat_t, txcnt),       sizeof(((txStat_t*)0)->txcnt),       NATIVE_FLAGS},
    {"MIN_TAGS[STRONG]", UINT32, offsetof(txStat_t, min_tags[0]), sizeof(((txStat_t*)0)->min_tags[0]), NATIVE_FLAGS},
    {"MIN_TAGS[WEAK]",   UINT32, offsetof(txStat_t, min_tags[1]), sizeof(((txStat_t*)0)->min_tags[1]), NATIVE_FLAGS},
    {"MAX_TAGS[STRONG]", UINT32, offsetof(txStat_t, max_tags[0]), sizeof(((txStat_t*)0)->max_tags[0]), NATIVE_FLAGS},
    {"MAX_TAGS[WEAK]",   UINT32, offsetof(txStat_t, max_tags[1]), sizeof(((txStat_t*)0)->max_tags[1]), NATIVE_FLAGS},
    {"AVG_TAGS[STRONG]", DOUBLE, offsetof(txStat_t, avg_tags[0]), sizeof(((txStat_t*)0)->avg_tags[0]), NATIVE_FLAGS},
    {"AVG_TAGS[WEAK]",   DOUBLE, offsetof(txStat_t, avg_tags[1]), sizeof(((txStat_t*)0)->avg_tags[1]), NATIVE_FLAGS},
    {"STD_TAGS[STRONG]", DOUBLE, offsetof(txStat_t, std_tags[0]), sizeof(((txStat_t*)0)->std_tags[0]), NATIVE_FLAGS},
    {"STD_TAGS[WEAK]",   DOUBLE, offsetof(txStat_t, std_tags[1]), sizeof(((txStat_t*)0)->std_tags[1]), NATIVE_FLAGS},
    {"MIN_DELTA",        DOUBLE, offsetof(txStat_t, min_delta),   sizeof(((txStat_t*)0)->min_delta),   NATIVE_FLAGS},
    {"MAX_DELTA",        DOUBLE, offsetof(txStat_t, max_delta),   sizeof(((txStat_t*)0)->max_delta),   NATIVE_FLAGS},
    {"AVG_DELTA",        DOUBLE, offsetof(txStat_t, avg_delta),   sizeof(((txStat_t*)0)->avg_delta),   NATIVE_FLAGS}
};
...
{
    {"PCE",            UINT32, offsetof(sigStat_t, pce),          sizeof(((sigStat_t*)0)->pce),         NATIVE_FLAGS},
    {"RWS[STRONG]",    DOUBLE, offsetof(sigStat_t, rws[0]),       sizeof(((sigStat_t*)0)->rws[0]),      NATIVE_FLAGS},
    {"RWS[WEAK]",      DOUBLE, offsetof(sigStat_t, rws[1]),       sizeof(((sigStat_t*)0)->rws[1]),      NATIVE_FLAGS},
    {"RWW[STRONG]",    DOUBLE, offsetof(sigStat_t, rww[0]),       sizeof(((sigStat_t*)0)->rww[0]),      NATIVE_FLAGS},
    {"RWW[WEAK]",      DOUBLE, offsetof(sigStat_t, rww[1]),       sizeof(((sigStat_t*)0)->rww[1]),      NATIVE_FLAGS},
    {"SIGRNG[STRONG]", DOUBLE, offsetof(sigStat_t, sigrng[0]),    sizeof(((sigStat_t*)0)->sigrng[0]),   NATIVE_FLAGS},
    {"SIGRNG[WEAK]",   DOUBLE, offsetof(sigStat_t, sigrng[1]),    sizeof(((sigStat_t*)0)->sigrng[1]),   NATIVE_FLAGS},
    {"BKGND[STRONG]",  DOUBLE, offsetof(sigStat_t, bkgnd[0]),     sizeof(((sigStat_t*)0)->bkgnd[0]),    NATIVE_FLAGS},
    {"BKGND[WEAK]",    DOUBLE, offsetof(sigStat_t, bkgnd[1]),     sizeof(((sigStat_t*)0)->bkgnd[1]),    NATIVE_FLAGS},
    {"SIGPES[STRONG]", DOUBLE, offsetof(sigStat_t, sigpes[0]),    sizeof(((sigStat_t*)0)->sigpes[0]),   NATIVE_FLAGS},
    {"SIGPES[WEAK]",   DOUBLE, offsetof(sigStat_t, sigpes[1]),    sizeof(((sigStat_t*)0)->sigpes[1]),   NATIVE_FLAGS},
    {"TEPPE[STRONG]",  DOUBLE, offsetof(sigStat_t, teppe[0]),     sizeof(((sigStat_t*)0)->teppe[0]),    NATIVE_FLAGS},
    {"TEPPE[WEAK]",    DOUBLE, offsetof(sigStat_t, teppe[1]),     sizeof(((sigStat_t*)0)->teppe[1]),    NATIVE_FLAGS},
};
