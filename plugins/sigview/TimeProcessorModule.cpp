...
{
    {"ERRORCNT",          UINT32, offsetof(timeStat_t, errorcnt),                   1,  NATIVE_FLAGS},
    {"SC_1PPS_FREQ",      DOUBLE, offsetof(timeStat_t, sc_1pps_freq),               1,  NATIVE_FLAGS},
    {"ASC_1PPS_FREQ",     DOUBLE, offsetof(timeStat_t, asc_1pps_freq),              1,  NATIVE_FLAGS},
    {"TQ_FREQ",           DOUBLE, offsetof(timeStat_t, tq_freq),                    1,  NATIVE_FLAGS},
    {"MF_FREQ[1]",        DOUBLE, offsetof(timeStat_t, mf_freq[0]),                 1,  NATIVE_FLAGS},
    {"MF_FREQ[2]",        DOUBLE, offsetof(timeStat_t, mf_freq[1]),                 1,  NATIVE_FLAGS},
    {"MF_FREQ[3]",        DOUBLE, offsetof(timeStat_t, mf_freq[2]),                 1,  NATIVE_FLAGS},
    {"SC_1PPS_TIME",      DOUBLE, offsetof(timeStat_t, sc_1pps_time),               1,  NATIVE_FLAGS},
    {"ASC_1PPS_TIME",     DOUBLE, offsetof(timeStat_t, asc_1pps_time),              1,  NATIVE_FLAGS},
    {"TQ_TIME",           DOUBLE, offsetof(timeStat_t, tq_time),                    1,  NATIVE_FLAGS},
    {"MF_TIME[1]",        DOUBLE, offsetof(timeStat_t, mf_time[0]),                 1,  NATIVE_FLAGS},
    {"MF_TIME[2]",        DOUBLE, offsetof(timeStat_t, mf_time[1]),                 1,  NATIVE_FLAGS},
    {"MF_TIME[3]",        DOUBLE, offsetof(timeStat_t, mf_time[2]),                 1,  NATIVE_FLAGS},
    {"SC_1PPS_AMET",      UINT64, offsetof(timeStat_t, sc_1pps_amet),               1,  NATIVE_FLAGS},
    {"ASC_1PPS_AMET",     UINT64, offsetof(timeStat_t, asc_1pps_amet),              1,  NATIVE_FLAGS},
    {"SC2ASC_AMET_DELTA", INT64,  offsetof(timeStat_t, sc_to_asc_1pps_amet_delta),  1,  NATIVE_FLAGS},
    {"USO_FREQ",          DOUBLE, offsetof(timeStat_t, uso_freq),                   1,  NATIVE_FLAGS},
    {"USO_FREQ_CALC",     UINT8,  offsetof(timeStat_t, uso_freq_calc),              1,  NATIVE_FLAGS},
    {"SC_1PPS_SRC",       INT32,  offsetof(timeStat_t, sc_1pps_source),             1,  NATIVE_FLAGS},
    {"USO_SRC",           INT32,  offsetof(timeStat_t, uso_source),                 1,  NATIVE_FLAGS},
    {"GPS_SYNC_SRC",      INT32,  offsetof(timeStat_t, gps_sync_source),            1,  NATIVE_FLAGS},
    {"INT_1PPS_SRC",      INT32,  offsetof(timeStat_t, int_1pps_source),            1,  NATIVE_FLAGS}
};
...
{
    {"REF",                       UINT32, offsetof(timeDiagStat_t, ref),                          1,    NATIVE_FLAGS},
    {"ASC_1PPS_GPS_REF",          DOUBLE, offsetof(timeDiagStat_t, asc_1pps_gps_ref),             1,    NATIVE_FLAGS},
    {"SC_1PPS_DELTA",             DOUBLE, offsetof(timeDiagStat_t, sc_1pps_delta),                1,    NATIVE_FLAGS},
    {"SC_TAT_RX_DELTA",           DOUBLE, offsetof(timeDiagStat_t, sc_tat_rx_delta),              1,    NATIVE_FLAGS},
    {"SC_ATT_RX_DELTA",           DOUBLE, offsetof(timeDiagStat_t, sc_att_rx_delta),              1,    NATIVE_FLAGS},
    {"SC_POS_RX_DELTA",           DOUBLE, offsetof(timeDiagStat_t, sc_pos_rx_delta),              1,    NATIVE_FLAGS},
    {"SC_ATT_SOL_DELTA",          DOUBLE, offsetof(timeDiagStat_t, sc_att_sol_delta),             1,    NATIVE_FLAGS},
    {"SC_POS_SOL_DELTA",          DOUBLE, offsetof(timeDiagStat_t, sc_pos_sol_delta),             1,    NATIVE_FLAGS},
    {"SXP_PCE_TIME_RX_DELTA[1]",  DOUBLE, offsetof(timeDiagStat_t, sxp_pce_time_rx_delta[0]),     1,    NATIVE_FLAGS},
    {"SXP_PCE_TIME_RX_DELTA[2]",  DOUBLE, offsetof(timeDiagStat_t, sxp_pce_time_rx_delta[1]),     1,    NATIVE_FLAGS},
    {"SXP_PCE_TIME_RX_DELTA[3]",  DOUBLE, offsetof(timeDiagStat_t, sxp_pce_time_rx_delta[2]),     1,    NATIVE_FLAGS},
    {"SXP_1ST_MF_EXTRAP_DELTA[1]",DOUBLE, offsetof(timeDiagStat_t, sxp_1st_mf_extrap_delta[0]),   1,    NATIVE_FLAGS},
    {"SXP_1ST_MF_EXTRAP_DELTA[2]",DOUBLE, offsetof(timeDiagStat_t, sxp_1st_mf_extrap_delta[1]),   1,    NATIVE_FLAGS},
    {"SXP_1ST_MF_EXTRAP_DELTA[3]",DOUBLE, offsetof(timeDiagStat_t, sxp_1st_mf_extrap_delta[2]),   1,    NATIVE_FLAGS},
    {"PCE_1ST_MF_1PPS_DELTA[1]",  DOUBLE, offsetof(timeDiagStat_t, pce_1st_mf_1pps_delta[0]),     1,    NATIVE_FLAGS},
    {"PCE_1ST_MF_1PPS_DELTA[2]",  DOUBLE, offsetof(timeDiagStat_t, pce_1st_mf_1pps_delta[1]),     1,    NATIVE_FLAGS},
    {"PCE_1ST_MF_1PPS_DELTA[3]",  DOUBLE, offsetof(timeDiagStat_t, pce_1st_mf_1pps_delta[2]),     1,    NATIVE_FLAGS},
    {"SXP_STATUS[0]",             DOUBLE, offsetof(timeDiagStat_t, sxp_status[0]),                1,    NATIVE_FLAGS},
    {"SXP_STATUS[1]",             DOUBLE, offsetof(timeDiagStat_t, sxp_status[1]),                1,    NATIVE_FLAGS},
    {"SXP_STATUS[2]",             DOUBLE, offsetof(timeDiagStat_t, sxp_status[2]),                1,    NATIVE_FLAGS},
    {"SXP_STATUS[3]",             DOUBLE, offsetof(timeDiagStat_t, sxp_status[3]),                1,    NATIVE_FLAGS},
    {"SXP_STATUS[4]",             DOUBLE, offsetof(timeDiagStat_t, sxp_status[4]),                1,    NATIVE_FLAGS},
    {"SXP_STATUS[5]",             DOUBLE, offsetof(timeDiagStat_t, sxp_status[5]),                1,    NATIVE_FLAGS}
};
