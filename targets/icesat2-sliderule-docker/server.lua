...
local orchestrator_url = cfgtbl["orchestrator_url"] or os.getenv("ORCHESTRATOR") or "http://10.0.1.5:8051"
...
local monitor = core.monitor(core.LOG, event_level, event_format) -- monitor only logs
