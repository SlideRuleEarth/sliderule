...
-- Attributes:
    ...
    runner.assert("-49.179290771484" == tostring(e1), "failed dataset read")
    ...
    runner.assert("29.29400062561" == tostring(e1), "failed dataset read")
    ...
    runner.assert("-91.40599822998" == tostring(e1), "failed dataset read")
    ...
    runner.assert("degrees_north" == vals, "failed dataset read")
    ...
    runner.assert("-89.5" == tostring(e1), "failed dataset read")
