...
RATELIMIT_WEEKLY_COUNT = os.getenv("RATELIMIT_WEEKLY_COUNT") and int(os.getenv("RATELIMIT_WEEKLY_COUNT")) or 100000 # maximum number of requests that can be made in one week
