...
runner.uittest("Meta (\u{221E}) global canopy height sample POI", function()
    ...
    local expResults = {{20.0, 1396483218, '/vsis3/' .. sys.getcfg("project_bucket") .. '/data/GLOBALCANOPY/META_GlobalCanopyHeight_1m_2024_v1.vrt'}}
