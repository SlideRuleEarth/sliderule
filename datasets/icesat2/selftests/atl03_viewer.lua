...
runner.unittest("ATL03 Viewer Extent Record", function()
    local recq = msg.subscribe("atl03-reader-recq")
    local tstart = time.latch()
    local f1 = icesat2.atl03v("atl03-reader-recq", icesat2.parms03({resource="ATL03_20200304065203_10470605_007_01.h5", track=icesat2.RPT_1}, nil, "icesat2"))
...
runner.unittest("ATL03 Viewer Extent Definition", function()
