...
local parms     = icesat2.parms08(rqst["parms"], rqst["key_space"], "icesat2-atl08", rqst["resource"])
...
return {
    ...
    schema = {
        ...
        request = [[ "application/json": {
            "schema": {
                "$ref": "../components/schemas/Atl08Parameters.json"
            }
        } ]],
        response = [[ "application/octet-stream": {
            "schema": {
                "$ref": "../components/schemas/Atl08DataFrame.json"
            }
        } ]]
    }
}
