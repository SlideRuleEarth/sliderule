...
if context == "local":
    # Create H5 Handles
    atl08 = sliderule.h5coro("ATL08_20181214194017_11790102_007_01.h5", "file", "/data/ATLAS", "", "")
    atl03 = sliderule.h5coro("ATL03_20181214194017_11790102_007_01.h5", "file", "/data/ATLAS", "", "")
elif context == "remote":
    # Setup Credentials
