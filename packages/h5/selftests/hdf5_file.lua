...
runner.unittest("H5Coro Read Dataset", function()
...
runner.unittest("H5Coro Read Dataset as Record", function()
...
runner.unittest("H5Coro Read Dataset Raw", function()
...
runner.unittest("H5Coro Slice Column via 2D Slice (1D result)", function()
    ...
    local recdata = rsps5:recvrecord(3000)
...
runner.unittest("H5Coro Slice 2D Block", function()
    ...
    local recdata = rsps6:recvrecord(3000)
...
runner.unittest("H5Coro Slice Out of Bounds (Negative)", function()
    ...
    local recdata = rsps10:recvrecord(1000)
...
runner.unittest("H5Coro Slice Start Greater Than End (Negative)", function()
    ...
    local recdata = rsps11n:recvrecord(1000)
