 ...
 * read
 *----------------------------------------------------------------------------*/
int H5IO::read (const char* url, const char* datasetname, int col, size_t datatypesize, uint8_t** data)
{
    int size = 1;
 ...
 * readAs
 *----------------------------------------------------------------------------*/
int H5IO::readAs (const char* url, const char* datasetname, RecordObject::valType_t valtype, uint8_t** data)
{
    int size = 0;
 ...
 * traverse
 *----------------------------------------------------------------------------*/
bool H5IO::traverse (const char* url, int max_depth, const char* start_group)
{
    bool        status = false;
    hid_t       file = INVALID_RC;
