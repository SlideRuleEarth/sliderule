...
runner.unittest("Request Parameters Defaults", function()
...
runner.unittest("Request Parameters Cluster Size Hint", function()
    local parms = core.parms({cluster_size_hint=9})
    local ptable = parms:export()
...
runner.unittest("Request Parameters Projected Polygon", function()
    local grandmesa = { {lon=-108.3435200747503, lat=38.89102961045247},
                        {lon=-107.7677425431139, lat=38.90611184543033},
                        {lon=-107.7818591266989, lat=39.26613714985466},
                        {lon=-108.3605610678553, lat=39.25086131372244},
                        {lon=-108.3435200747503, lat=38.89102961045247} }
    local parms = core.parms({poly=grandmesa})
    local ptable = parms:export()
...
runner.unittest("Request Parameters Region Mask", function()
    ...
    local parms = core.parms({region_mask={geojson=dicksonfjord, cellsize=0.001}})
    local ptable = parms:export()
