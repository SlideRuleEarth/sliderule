...
runner.unittest("TimeLib Unit Test", function()
...
runner.unittest("Lua TimeLib Test #1", function()
...
runner.unittest("Lua TimeLib Test #2", function()
    local t1 = time.gmt2gps("2021-06-05 08:05:41+00:00")
    local year, month, day, hour, minute, second, millisecond = time.gps2date(t1)
    runner.assert(year == 2021.0, "incorrect year: " .. tostring(year))
    runner.assert(month == 6.0, "incorrect month: " .. tostring(month))
...
runner.unittest("Lua TimeLib Test #3", function()
    local t1 = time.gmt2gps("2021-06-05 08:05:41+00:00")
