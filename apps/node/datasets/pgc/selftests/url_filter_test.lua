...
runner.unittest("PGC Url Filter: /vsis3", function()
    ...
    local url = "vsis3"
    local dem = geo.raster(geo.parms({asset=demType, algorithm="NearestNeighbour", catalog=contents, radius=0, with_flags=true, substr=url, sort_by_index=true}))
...
runner.unittest("PGC Url Filter: SETSM*", function()
    local url = "SETSM_s2s041_W1W1_20110405_102001001233F900_10200100126E8A00"
    local expResults = {{112.46093750, 0x0, "/vsis3/pgc-opendata-dems/arcticdem/strips/s2s041/2m/n70w150/SETSM_s2s041_W1W1_20110405_102001001233F900_10200100126E8A00_2m_seg3_dem.tif"}}
    local dem = geo.raster(geo.parms({asset=demType, algorithm="NearestNeighbour", catalog=contents, radius=0, with_flags=true, substr=url, sort_by_index=true}))
    local tbl, err = dem:sample(lon, lat, height)
    runner.assert(err == 0)
    runner.assert(tbl ~= nil)
...
runner.unittest("PGC Url Filter: WV01", function()
    local expResults = {
        {116.13281250, 0x0, '/vsis3/pgc-opendata-dems/arcticdem/strips/s2s041/2m/n70w150/SETSM_s2s041_WV01_20210327_10200100A69B7D00_10200100A9635700_2m_lsf_seg1_dem.tif'},
        {117.26562500, 0x0, '/vsis3/pgc-opendata-dems/arcticdem/strips/s2s041/2m/n70w150/SETSM_s2s041_WV01_20200429_1020010095DF8A00_10200100977C2200_2m_lsf_seg1_dem.tif'},
        {117.71093750, 0x0, '/vsis3/pgc-opendata-dems/arcticdem/strips/s2s041/2m/n69w150/SETSM_s2s041_WV01_20200312_1020010099356D00_102001009077A100_2m_lsf_seg1_dem.tif'},
